...
def process_all_faces(output_csv="data/features_all.csv"):
    """Process all faces in the directory and save features to a CSV file."""
    ...
    if os.path.exists(output_csv):
        with open(output_csv, "r") as csvfile:
            ...
            for row in reader:
                existing_data[row[0]] = row[1:]  # Store person name as key and features as value
